 ...
 * @类描述：
 * @创建人：huaiying
 * @创建时间：2015年7月31日 上午9:16:28
 * @修改人：huaiying
 * @修改时间：2015年7月31日 上午9:16:28
 * @修改备注：
 * @version
 */
public class WheelView extends ScrollView {
    ...
    private TextView createView(String item) {
        ...
        int padding = DeviceUitls.dip2px(context, 15);
        tv.setPadding(padding, padding, padding, padding);
        if (0 == itemHeight) {
            itemHeight = DeviceUitls.getViewMeasuredHeight(tv);
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            ...
            paint.setStrokeWidth(DeviceUitls.dip2px(context, 1f));
        }
